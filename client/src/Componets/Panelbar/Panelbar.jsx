    ...
    <div className='panel-container'>
        ...
        <div className='panels-container'>
            <div className='panel-name-container'>
                ...
                <span className='panel-value' style={{color:'brown'}}>16</span>
            </div>
            <div className="vertical-line"></div>
            <div className='panel-name-container'>
                <span className='panel-name'>Nurse</span>
                <span className='panel-value' style={{color:'darkblue'}}>16</span>
            </div>
            <div className="vertical-line"></div>
            <div className='panel-name-container'>
                <span className='panel-name'>Pharmacist</span>
                <span className='panel-value' style={{color:'green'}}>16</span>
            </div>
            <div className="vertical-line"></div>
            <div className='panel-name-container'>
            ...
            <div className='panel-name-container'>
                ...
                <span className='panel-value' style={{color:'steelblue'}}>16</span>
            </div>
            <div className="vertical-line"></div>
            <div className='panel-name-container'>
                <span className='panel-name'>Accountant</span>
                <span className='panel-value' style={{color:'purple'}}>16</span>
            </div>
        </div>
    </div>
    </div>
