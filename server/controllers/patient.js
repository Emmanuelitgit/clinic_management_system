...
export const addPatient = (req, res)=>{
    ...
    const query = "INSERT INTO patient(`name`, `email`, `phone`, `address`, `age`, `sex`, `birth_date`, `blood_group`) VALUES(?)";
...
export const updatePatient = (req, res)=>{
    ...
    const query = "UPDATE patient SET name=?, email=?, phone=?, address=?, age=?, sex=?, birth_date=?, blood_group=? WHERE patient_id=?";
...
export const addVital = (req, res)=>{
    ...
    const query = "INSERT INTO vital(`patient_id`, `nurse_id`, `bp_level`, `temperature`, `height`, `age`, `date`) VALUES(?)";
...
export const updateVital = (req, res)=>{
    ...
    const updateId = req.params.id;
    const query = "UPDATE vital SET patient_id=?, nurse_id=?, bp_level=?, temperature=?, height=?, age=?, date=? WHERE vital_id=?";
